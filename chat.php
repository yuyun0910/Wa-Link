...
<body id="page-top">
  ...
  <div id="wrapper">
    ...
    <h6 class="m-0 font-weight-bold text-primary">Write WhatsApp Message:</h6>
                </div>
                <?php
                include 'model.php';
                //mengambil data
             ...
             <textarea class="form-control" type="text" name='message' placeholder="Send Message..." id="floatingTextarea2" style="height: 100px" required></textarea>
              <input class="form-control" type="hidden" name='number' placeholder="Mobile Phone Number..." value="<?php echo $row['number']; ?>" required>
                     </div>

      <button type="submit" class="btn btn-primary btn-lg btn-block mt-3" name='send'>Creat</button>
                    </div>
     ...
     <img class="mt-2" src="group.png" alt="Group" width="200px" height="200px">
                  </div>
