    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <div class="container-fluid">
                ...
                <h6 class="m-0 font-weight-bold text-primary">Add Friend:</h6>
                          </div>
                          <!-- Card Body -->
                          <div class="card-body">
                            ...
                            <div class="row ml-4 mb-2">
                              ...
                              <input class="form-control" type="text" name='name' placeholder="Friend's Name..." required>
                              </div>

                              <div class="col-md-5 col-sm-12 col-xs-12">
                                <p><b>Address:</b></p>
                                <input class="form-control" type="text" name='address' placeholder="Friend's Address..." required>
                              </div>
                            </div>
                            ...
                            <div class="row ml-4 mb-4">
                              ...
                              <input class="form-control" type="number" name='number' placeholder="62888xxx..." required>
                              </div>

                            <div class="col-md-5 col-sm-12 col-xs-12 mt-4">
                            <button type="submit" class="btn btn-info btn-lg btn-block" name='send'>Send</button>
